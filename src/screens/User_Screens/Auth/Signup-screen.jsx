        ...
        <SafeAreaView style={styles.container}>
            ...
            <KeyboardAvoidingView style={{ flex: 1 }}>
                ...
                <View style={{ justifyContent: "center", flexDirection: "row" }}>
                    <Text style={{ marginTop: 50, fontWeight: "bold", color: GREEN_COLORS.GREEN, fontSize: 25 }}>Sign Up</Text>
                </View>
                ...
                <View style={styles.inputcontainer}>
                    ...
                    <View style={styles.inputView}>
                        <Ionicons name="person" size={30} color="black" style={{ color: GRAY_COLORS.MEDIUM_GRAY, marginTop: 0, marginLeft: 5, position: "absolute", zIndex: 2 }} />
